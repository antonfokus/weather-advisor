...
def get_songs_by_weather(weather_col, tf_idf_col, weather_variable, num_of_recommend):
    """
        Описание:
            Цель этой функции рекомендовать заданное количество песен из имеющегося набора данных на основе выбранного типа погоды с учётом сходства информации о данных между собой , в порядке убывания популярности.
...
def get_movies_by_weather(weather_col, tf_idf_col, weather_variable, num_of_recommend):
    """
        Описание:
            Цель этой функции рекомендовать заданное количество фильмов из имеющегося набора данных на основе выбранного типа погоды с учётом сходства информации о данных между собой , в порядке убывания рейтинга.
